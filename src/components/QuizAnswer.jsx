                                ...
                                <span key={pos}
                                    className={
                                        question.correct_answer === option ?
                                            ...
                                            question.clicked_index === pos ? "inline-block border border-[#D6DBF5] px-3 py-1 mr-3 my-1 rounded-full bg-red-200 " :
                                                "inline-block border border-[#D6DBF5] px-3 py-1 mr-3 my-1 rounded-full"}>{option}</span>))}
                        </div>
                    </div>)}
                    <div className="mt-5 flex justify-center items-center">
                        <p className="text-xl font-bold text-primary mr-3">You Scored {score}/5 correct answers</p>
                        <Button sx={{
